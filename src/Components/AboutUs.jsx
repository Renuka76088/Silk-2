        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-light tracking-wide text-amber-100">
              Pareekh Textile of Silk
            </h2>
            <p className="text-lg md:text-xl leading-relaxed text-gray-300">
              Established with a passion for pure craftsmanship, Pareekh Textile has been weaving dreams into reality for over three decades. Rooted in the heart of India's rich silk heritage, we blend age-old techniques with modern elegance to create fabrics that whisper luxury.
            </p>
            <p className="text-lg md:text-xl leading-relaxed text-gray-300">
